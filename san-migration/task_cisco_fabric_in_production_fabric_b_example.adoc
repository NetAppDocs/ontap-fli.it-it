...
summary: Di seguito viene riportato un esempio di fabric Cisco in Production Fabric B. 
---
= Esempio di fabric Cisco in Production Fabric B.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Di seguito viene riportato un esempio di fabric Cisco in Production Fabric B.
