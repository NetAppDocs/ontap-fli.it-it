...
summary: Di seguito viene riportato un esempio di fabric Brocade in Production Fabric A. 
---
= Brocade Fabric in Production Fabric un esempio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Di seguito viene riportato un esempio di fabric Brocade in Production Fabric A.
