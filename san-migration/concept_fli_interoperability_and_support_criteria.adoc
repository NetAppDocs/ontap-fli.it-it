...
summary: 'La matrice di interoperabilità FLI (IMT) è uno strumento di interoperabilità decisamente diverso, progettato per supportare al meglio gli array sorgente qualificati NetApp che funzionano con FLI.' 
---
...
[role="lead"]
La matrice di interoperabilità FLI (IMT) è uno strumento di interoperabilità decisamente diverso, progettato per supportare al meglio gli array sorgente qualificati NetApp che funzionano con FLI.
