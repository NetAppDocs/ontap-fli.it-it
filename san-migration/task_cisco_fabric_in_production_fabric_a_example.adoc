...
summary: Di seguito viene riportato un esempio di fabric Cisco in Production Fabric A. 
---
= Il fabric Cisco nel fabric di produzione è un esempio
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Di seguito viene riportato un esempio di fabric Cisco in Production Fabric A.

.Fasi
. Creare la zona nel fabric di produzione A.
+
[listing]
----
conf t
...
----
. Attivare la zona nel fabric di produzione A.
+
[listing]
----
conf t
