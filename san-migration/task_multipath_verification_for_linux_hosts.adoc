...
---
= Verifica multipath per host Linux
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Completare i seguenti passaggi per gli host Linux.

.Fase
. Per verificare che il multipath DM-MP sia configurato e funzioni correttamente su un host Linux, eseguire i seguenti comandi:``multipath -ll``
+
[listing]
----
